...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
            ...
            providers: [
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _auth_auth_interceptor__WEBPACK_IMPORTED_MODULE_8__["AuthInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _error_interceptor__WEBPACK_IMPORTED_MODULE_9__["ErrorInterceptor"], multi: true }
            ],
...
module.exports = ":host {\n  display: block;\n  /*margin-top: 1rem;*/\n}\n\nmat-form-field,\ntextarea {\n  width: 100%;\n}\n\nmat-spinner {\n  margin: auto;\n}\n\ninput[type=\"file\"] {\n  visibility: hidden;\n}\n\n.image-preview {\n  height: 5rem;\n  margin: 1rem 0;\n}\n\n.image-preview img {\n  height: 100%;\n  box-shadow: 1px 1px 5px rgba(0, 0, 0, 0.5);\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PostCreateComponent = /** @class */ (function () {
    ...
    PostCreateComponent.ctorParameters = function () { return [
        { type: _post_service__WEBPACK_IMPORTED_MODULE_4__["PostsService"] },
    ...
    PostCreateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_post_service__WEBPACK_IMPORTED_MODULE_4__["PostsService"],
...
var PostListComponent = /** @class */ (function () {
    ...
    PostListComponent.prototype.onDelete = function (postId) {
        ...
        this.postsService.deletePost(postId).subscribe(function () {
            if (_this.totalPosts - 1 - _this.postsPerPage * (_this.currentPage - 1) <=
                0) {
                _this.currentPage = _this.currentPage === 1 ? 1 : _this.currentPage - 1;
                _this.paginator.pageIndex = _this.currentPage - 1;
                _this.totalPosts = _this.totalPosts === 0 ? 0 : _this.totalPosts - 1;
                _this.paginator.page.next({
                    pageIndex: _this.paginator.pageIndex,
                    pageSize: _this.paginator.pageSize,
                    length: _this.totalPosts
                });
            }
    ...
    PostListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_post_service__WEBPACK_IMPORTED_MODULE_2__["PostsService"],
...
var PostsService = /** @class */ (function () {
    ...
    PostsService.prototype.updatePost = function (id, title, content, image) {
        ...
        this.http.put(BACKEND_URL + id, postData).subscribe(function () {
            _this.router.navigate(["/"]);
        });
    };
...
module.exports = __webpack_require__(/*! /home/navin/Apps/github/Angular-NodeJS---The-MEAN-Stack-Guide/src/main.ts */"./src/main.ts");
